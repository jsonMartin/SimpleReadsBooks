...
<Footer footerType="socialmedia" class="bg-[#420063]">
  <div class="m-auto max-w-screen-xl">
    <div
      class="mb-2 grid grid-flow-row grid-cols-12 gap-4 sm:items-center sm:justify-between"
    >
      <FooterBrand
        href="/"
      ...
      <div
        class="col-start-1 col-end-13 w-full rounded-xl md:col-start-10"
        ...
        tabindex="0"
      >
        <p class="bg-transparent pb-1 text-xs text-white">
        ...
        <ButtonGroup class="w-full rounded-none">
          <Input
            ...
            size="sm"
            class="!rounded-none !rounded-bl !rounded-tl"
          >
            <svg
              slot="left"
              aria-hidden="true"
    ...
    <div
      class="flex flex-col items-center justify-center sm:flex-row sm:items-center sm:justify-between"
    >
      <FooterCopyright
        href="/"
      ...
      />
      <div
        class="mt-4 flex items-center space-x-6 text-white sm:mt-0 sm:justify-center"
      >
        <FooterIcon
        ...
        >
          <img
            src="/images/goodreads-icon.png"
            class="w-[20px] grayscale filter"
          />
        </FooterIcon>
      </div>
    </div>
