...
<Modal bind:open={confirmModal} size="xs" autoclose>
  <div class="text-center">
    <CheckSolid
      class="mx-auto mb-4 h-14 w-14 text-green-600 dark:text-green-400"
    />
...
<section class="bg-white dark:bg-gray-900">
  <div class="mx-auto max-w-screen-md px-4 py-8 !pt-8 lg:py-16">
    <h2
      class="mb-4 text-center text-5xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl md:text-7xl"
    >
      Contact Us
    </h2>
    <p
    ...
    >
      Have any questions or comments? Let us know how we can help.
    </p>
    ...
    >
      ...
      <div>
        ...
        <Label class="space-y-2">
          ...
          >
            <PenSolid slot="left" class="h-5 w-5" />
          </Input>
        </Label>
      </div>
